...
class TestAnthropicScenarios < Minitest::Test
  ...
  def test_inventory_lookup
    ...
    VCR.use_cassette("anthropic_scenario_inventory") do
  ...
  def test_weather_outdoor_recommendation
    ...
    VCR.use_cassette("anthropic_scenario_weather") do
      agent = Kernai::Agent.new(
  ...
  def test_data_analysis_premium_users
    ...
    VCR.use_cassette("anthropic_scenario_data_analysis") do
      agent = Kernai::Agent.new(
