...
module ScenarioHelpers
  ...
  def setup_user_database_skill
    Kernai::Skill.define(:user_database) do
      ...
      execute do |_params|
        users = [
          { id: 1, name: "Alice Martin", email: "alice@example.com", status: "active", plan: "premium", signup_date: "2024-01-15" },
          { id: 2, name: "Bob Smith", email: "bob@example.com", status: "active", plan: "free", signup_date: "2024-03-22" },
          { id: 3, name: "Charlie Brown", email: "charlie@example.com", status: "inactive", plan: "premium", signup_date: "2023-11-08" },
          { id: 4, name: "Diana Prince", email: "diana@example.com", status: "active", plan: "premium", signup_date: "2024-06-01" },
          { id: 5, name: "Eve Wilson", email: "eve@example.com", status: "active", plan: "free", signup_date: "2024-07-19" },
          { id: 6, name: "Frank Lee", email: "frank@example.com", status: "inactive", plan: "free", signup_date: "2023-09-30" },
        ]
        JSON.generate(users)
      end
    end
  ...
  CALCULATOR_INSTRUCTIONS = <<~PROMPT
  ...
  WEATHER_ADVISOR_INSTRUCTIONS = <<~PROMPT
  ...
  DATA_ANALYST_INSTRUCTIONS = <<~PROMPT
